...
def change_cvs(transaction_code, tin_obj, engine_size, cost_price, chassis_number, staff_obj):
	...
	try:
		...
		if (engine_size == "1.6 - 2.0" and cost_price =="Price of vehicle above 1 million"):
				...
				TransactionAssessment.objects.create(transaction_code = transaction_code, tin = tin_obj , expiration_date = expirationdate_6months, chassis_number  =  chassis_number, particulars = particulars, amount = amount,  transaction_type = "Change of ownership", staff = staff_obj)
