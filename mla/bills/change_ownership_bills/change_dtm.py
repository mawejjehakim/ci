...
def change_dtm(transaction_code, tin_obj, engine_size, cost_price, chassis_number, staff_obj):
...
# GENERATE BILL
	...
	#Get particulars [Registration Fee]
		...
		TransactionAssessment.objects.create(transaction_code = transaction_code, tin = tin_obj, chassis_number  =  chassis_number, particulars = particulars, expiration_date =expirationdate_1year, amount = amount,  transaction_type = "Change of ownership", staff = staff_obj)
