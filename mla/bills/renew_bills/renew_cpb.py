...
def renew_cpb(assessment_type, tin_obj, chassis_number, staff_obj) :
	...
	try:
		...
		if assessment_type == "Vehicle License [1.6 - 2.0]" :
			...
			charge_public_vehicle =  Charge.objects.get(options ='Renew',  vehicle_type ='Commercial Pickup/Bus',  particulars ='Vehicle License [1.6 - 2.0]')
		...
		#Get particulars [Vehicle License [2.1 - 3.0]]
			...
			charge_vehicle_license_btn2_3  = Charge.objects.get(options = 'Renew',  vehicle_type ='Commercial Pickup/Bus', 	 particulars ='Vehicle License [2.1 - 3.0]')
		...
		#Get particulars [Vehicle License [3.1 - Above]]				  
			...
			charge_vehicle_license_above3 =  Charge.objects.get(options = 'Renew',  vehicle_type ='Commercial Pickup/Bus',  particulars ='Vehicle License [3.1 - Above]' )
		...
		#Get particulars Certificate of road worthiness
			...
			charge_certificate_of_road_worthiness = Charge.objects.get(options ='Renew',  vehicle_type ='Commercial Pickup/Bus',  particulars ='Certificate of road worthiness' )
		...
		#Get particulars Proof of ownership
			...
			charge_proof_of_ownership = Charge.objects.get(options = 'Renew',  vehicle_type ='Commercial Pickup/Bus',  particulars ='Proof of ownership' )
		...
		#Get particulars New Plate Number				  
			...
			charge_new_plate_number = Charge.objects.get(options = 'Renew', vehicle_type ='Commercial Pickup/Bus',  particulars ='New Plate Number' )
		...
		#Get particulars Registration Book
			...
			charge_registration_book = Charge.objects.get(options = 'Renew', vehicle_type ='Commercial Pickup/Bus',  particulars ='Registration Book' )
		...
		#Get particulars Driver Badge
			...
			charge_driver_badge = Charge.objects.get(options = 'Renew', vehicle_type ='Commercial Pickup/Bus', particulars ='Driver Badge' )
		...
		#Get particulars Hackney permit
			...
			charge_hackney_permit = Charge.objects.get(options = 'Renew', vehicle_type ='Commercial Pickup/Bus',  particulars ='Hackney permit' )
		...
		#Get particulars Conductors Badge
			...
			charge_conductor_badge = Charge.objects.get(options = 'Renew', vehicle_type ='Commercial Pickup/Bus', particulars ='Conductors Badge' )
		...
		#Get particulars SMS Alert
			...
			charge_sms_alert = Charge.objects.get(options = 'Renew', vehicle_type ='Commercial Pickup/Bus', particulars = "SMS Alert" )
		...
		#Get particulars Stamp Duty
			...
			charge_stamp_duty = Charge.objects.get(options = 'Renew', vehicle_type ='Commercial Pickup/Bus',  particulars ='Stamp Duty' )
