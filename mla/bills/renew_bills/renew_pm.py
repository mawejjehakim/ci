...
def renew_pm(assessment_type, tin_obj, chassis_number, staff_obj) :
	...
	try:
		...
		if assessment_type == "Vehicle License Tricycle":	
			...
			vehicle_license_tricycle = Charge.objects.get(options = 'Renew', vehicle_type='Private Motorcycle', particulars='Vehicle License Tricycle' )

			particulars = "Vehicle License Tricycle";
			amount = vehicle_license_tricycle.amount
		...
		#Get particulars [Vehicle License Motorcycle]
			...
			vehicle_license_motocycle = Charge.objects.get(options = 'Renew' , vehicle_type='Private Motorcycle', 	particulars='Vehicle License Motorcycle' )
				
			particulars = "Vehicle License Motorcycle";
			amount = vehicle_license_motocycle.amount
		...
		#Get particulars Certificate of road worthiness
			...
			charge_certificate_of_road_worthiness = Charge.objects.get(options = 'Renew', vehicle_type='Private Motorcycle', particulars='Certificate of road worthiness' )
		...
		#Get particulars Proof of ownership			  
			...
			charge_proof_of_ownership  = Charge.objects.get(options = 'Renew', vehicle_type='Private Motorcycle', particulars='Proof of ownership' )
		...
		#Get particulars New Plate Number				  
			...
			charge_new_plate_number = Charge.objects.get(options = 'Renew', vehicle_type='Private Motorcycle', 	particulars='New Plate Number' )
		...
		#Get particulars Driver Badge
			...
			charge_driver_badge = Charge.objects.get(options = 'Renew', vehicle_type='Private Motorcycle', particulars='Driver Badge' )
		...
		#Get particulars Hackney permit
			...
			charge_hackney_permit = Charge.objects.get(options = 'Renew', vehicle_type='Private Motorcycle', 	particulars='Hackney permit' )
		...
		#Get particulars SMS Alert
			...
			charge_sms_alert = Charge.objects.get(options = 'Renew', vehicle_type='Private Motorcycle', particulars='SMS Alert' )
		...
		#Get particulars Stamp Duty
			...
			charge_stamp_duty= Charge.objects.get(options = 'Renew',  vehicle_type='Private Motorcycle', particulars='Stamp Duty' )
