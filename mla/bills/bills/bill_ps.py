...
def bill_ps(tin_obj,engine_size, cost_price, chassis_number, staff_obj):
	...
	try:				
		...
		if (engine_size == "1.6 - 2.0" and cost_price =="Price of vehicle above 1 million"):
			...
			TransactionAssessment.objects.create(transaction_code = transaction_code,  expiration_date = expirationdate_1year, tin = tin_obj, chassis_number  =  chassis_number, particulars = particulars, amount = amount,  transaction_type = "New Vehicle Registration",  staff = staff_obj)			 
			print("hreeeeeeee8")
