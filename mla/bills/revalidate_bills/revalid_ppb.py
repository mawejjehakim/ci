...
def revalid_ppb(transaction_code, tin_obj, engine_size, cost_price, chassis_number, staff_obj): 
...
# 1.6 - 2.0   -  Above 1 million
		...
		#Get particulars [Registration Book]
			...
			charge_certificate_of_road_worthiness =  Charge.objects.get(options ='New', vehicle_type='Private Pickup/Bus', particulars='Certificate of road worthiness' )
			...
			charge_vehicle_license1_2 =  Charge.objects.get(options ='New', vehicle_type='Private Pickup/Bus', particulars='Vehicle License [1.6 - 2.0]' )
			...
			charge_hackney_permit =  Charge.objects.get(options ='New', vehicle_type='Private Pickup/Bus', particulars='Hackney permit' )
			...
			charge_driver_badge =  Charge.objects.get(options ='New', vehicle_type='Private Pickup/Bus', particulars='Driver Badge' )
...
# 2.1 - 3.0   -  Above 1 million
			...
			charge_vehicle_license2_3 =  Charge.objects.get(options ='New', vehicle_type='Private Pickup/Bus', particulars='Vehicle License [2.1 - 3.0]' )
		...
		# 3.1 - Above   -  Above 1 million
			...
			charge_vehicle_license_3above =  Charge.objects.get(options ='New', vehicle_type='Private Pickup/Bus', particulars='Vehicle License [3.1 - above]' )
